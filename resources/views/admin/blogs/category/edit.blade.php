                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="meta_title" id=""
                                                            class="form-control" value="{{ $category['meta_title'] }}"  placeholder="Meta Title">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="meta_keyword" id=""
                                                            class="form-control" value="{{ $category['meta_keyword'] }}"  placeholder="Meta Keywords">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <textarea type="text" name="meta_description" id=""
                                                            class="form-control" cols="30" rows="10" value=""  placeholder="Meta Description">{{ $category['meta_description'] }}</textarea>
