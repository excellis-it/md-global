                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select name="type" class="form-control" id="">
                                                            ...
                                                            <option value="Frontend" {{ $privacyPolicy->type == 'Frontend' ? 'selected' : '' }}>Frontend</option>
                                                            <option value="Doctor" {{ $privacyPolicy->type == 'Doctor' ? 'selected' : '' }}>Doctor</option>
                                                            <option value="Patient" {{ $privacyPolicy->type == 'Patient' ? 'selected' : '' }}>Patient</option>
                                                        </select>
                                                        @if ($errors->has('type'))
