...
@section('title')
    {{ env('APP_NAME') }} | Create Terms & Condition
@endsection
@push('styles')
@endpush
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Create Terms & Condition</li>
                        </ul>
                    </div>
                    <div class="col-auto float-end ms-auto">
                        {{-- <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_group"><i
                            class="fa fa-plus"></i> Add Terms & Condition</a> --}}
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-title">
                        <div class="row">
                            <div class="col-xl-12 mx-auto">
                                <h6 class="mb-0 text-uppercase">Create A Terms & Condition</h6>
                                <hr>
                                <div class="card border-0 border-4">
                                    <div class="card-body">
                                        <form action="{{ route('cms.terms-and-condition.store') }}" method="post"
                                            ...
                                            <div class="border p-4 rounded">
                                                <div class="row">
                                                    ...
                                                    <div class="row" style="margin-top: 20px; float: left;">
                                                        <div class="col-sm-9">
                                                            <button type="submit"
                                                                class="btn px-5 submit-btn"><i class="la la-paper-plane"></i> Send Terms & Condition</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
