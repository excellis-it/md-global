                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('video-call-price.index') }}">Video Calling
                                    Price</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="card-title">
                        <div class="row">
                            <div class="col-xl-12 mx-auto">
                                <h6 class="mb-0 text-uppercase">Video Calling Price</h6>
                                <hr>
                                <div class="card border-0 border-4">
                                    <div class="card-body">
                                        <form action="{{ route('video-call-price.store') }}" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mt-4">
                                                        <textarea name="description" id="description"
                                                            class="form-control" placeholder="Plan Description*">{{ old('description') }}</textarea>
