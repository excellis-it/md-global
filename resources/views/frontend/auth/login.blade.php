                                ...
                                <div class="login_form">
                                    <form class="" action="{{ route('login.check') }}" method="post">
                                        ...
                                        <div class="form-group">
                                         ...
                                         {{-- user_type patient or medical stuff --}}
                                         {{-- <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="user_type"
                                                    id="doctorRadio" value="medical stuff" {{ old('user_type') == 'doctor' ? 'checked' : '' }}>
                                        ...
                                        <div class="login-text login-text-2 text-center">
                                            <p>
                                                Are you a medical stuff looking to log in? <a href="{{ route('medical-stuff.login') }}">Login NOW</a>
                                            </p>
                                        </div>
                                    </form>
                                </div>
