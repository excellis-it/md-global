                ...
                <div class="nav_list">
                    <ul>
                        <li><a href="{{ route('doctor.dashboard') }}"
                                class="nav_link {{ Request::is('medical-stuff/dashboard') ? 'active' : '' }}"> <i
                                    class='bx bx-grid-alt nav_icon'></i>
                                <span class="nav_name">Dashboard</span> </a>
                        </li>
                        <li><a href="#"
                                class="nav_link sub-link {{ Request::is('medical-stuff/profile') || Request::is('medical-stuff/change-password') ? 'active' : '' }}">
                                <i class='bx bxs-user nav_icon'></i><span class="nav_name">Manage
                                    Account</span></a>
                            <ul class="sub-nav">
                                <li><a href="{{ route('doctor.profile') }}"
                                        class="nav_link {{ Request::is('medical-stuff/profile') ? 'sub-li-active' : '' }}">
                                        <i class='bx bxs-user'></i><span class="nav_name">My
                                            Profile</span> </a></li>
                                <li><a href="{{ route('doctor.change.password') }}"
                                        class="nav_link {{ Request::is('medical-stuff/change-password') ? 'sub-li-active' : '' }}">
