                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row check-box m-0 p-0">
                                                        ...
                                                        <select name="specialization_id[]" id="specialization_id"
                                                            ...
                                                            @foreach ($specializations as $specialization)
                                                                <option value="{{ $specialization['id'] }}"
                                                                    @if (Auth::user()->doctorSpecializations->count() > 0) @foreach (Auth::user()->doctorSpecializations as $item) @if ($item['specialization_id'] == $specialization['id']) selected @endif
                                                                    @endforeach
                                                            @endif>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id=""
                                                            value="{{ Auth::user()->year_of_experience }}"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>Address</label>
                                                        <input type="text" class="form-control" id=""
                                                            value="{{ Auth::user()->location }}" name="address"
                                                            placeholder="Address">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        @if ($errors->has('education'))
                                                            <span
                                                                class="text-danger">{{ $errors->first('education') }}</span>
                                                        @endif
                                                    </div>
                                                    {{-- about_yourself --}}
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control" id="" name="about_yourself"
                                                            placeholder="About Yourself">{{ Auth::user()->about_yourself }}</textarea>
                                                        @if ($errors->has('about_yourself'))
                                                            <span
                                                                class="text-danger">{{ $errors->first('about_yourself') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
