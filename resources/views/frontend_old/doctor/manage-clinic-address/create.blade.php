                                                    ...
                                                    <div class="row g-3">
                                                        <div class="form-group col-lg-6 col-md-12">
                                                            <input type="text" class="form-control" id="clinic_name"
                                                                name="clinic_name" value="" placeholder="Service Centers Name"
                                                                required="">
                                                        ...
                                                        <div class="form-group col-lg-12 col-md-12">
                                                            <input type="text" class="form-control" id="autocomplete"
                                                                ...
                                                                placeholder="Service Centers Address" required="">
                                                                ...
                                                                <div class="col-xl-2">
                                                                    <div class="form-check form-check-1">
                                                                        <label class="form-check-label"
                                                                            ...
                                                                            Choose Your Service Centers Open Days
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-8">
